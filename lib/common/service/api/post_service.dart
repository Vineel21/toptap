...
class PostService {
  ...
  Future<StatusModel> deleteComment(
      {int? commentId}) async {
    StatusModel model = await ApiService.instance.call(
  ...
  Future<StatusModel> deleteCommentReply(
      {int? replyId}) async {
    StatusModel model = await ApiService.instance.call(
  ...
  Future<StatusModel> increaseShareCount(
      {int? postId}) async {
    StatusModel model = await ApiService.instance.call(
  ...
  Future<StatusModel> increaseViewsCount(
      {int? postId}) async {
    StatusModel model = await ApiService.instance.call(
  ...
  Future<StatusModel> disLikeComment(
      {int? commentId}) async {
    StatusModel model = await ApiService.instance.call(
  ...
  Future<StatusModel> unPinComment(
      {required int commentId}) async {
    StatusModel model = await ApiService.instance.call(
  ...
  Future<StatusModel> disLikePost(
      {required int postId}) async {
    StatusModel model = await ApiService.instance.call(
  ...
  Future<List<Music>> fetchMusicExplore(
      {int? lastItemId}) async {
  ...
  Future<List<Music>> fetchSavedMusics() async {
    MusicsModel response = await ApiService.instance.call(
        url: WebService.post.fetchSavedMusics,
        fromJson: MusicsModel.fromJson);
  ...
  Future<StoryModel> createStory({
    ...
    StoryModel response = await ApiService.instance
        .multiPartCallApi(
  ...
  Future<Music?> addUserMusic({
    ...
    MusicModel response =
        await ApiService.instance.multiPartCallApi(
  ...
  Future<List<User>> fetchStory() async {
    StoriesModel response = await ApiService.instance.call(
        url: WebService.post.fetchStory,
        fromJson: StoriesModel.fromJson);
    if (response.status == true) {
      return response.data ?? [];
    }
    return [];
  ...
  Future<ExplorePageData?> fetchExplorePageData() async {
    ExplorePageModel response = await ApiService.instance
        .call(
  ...
  // TODO: Add these new API methods to fully implement the tabs

  /// Fetch posts that user has liked (for favorites tab)
  Future<List<Post>> fetchLikedPosts(
      {required String type,
      required int? lastItemId}) async {
    // TODO: Backend needs to implement this endpoint
    PostsModel model = await ApiService.instance.call(
        url:
            "${WebService.post.fetchUserPosts}/liked", // New endpoint needed
        param: {
          Params.types: type,
          Params.limit: AppRes.paginationLimit,
          Params.lastItemId: lastItemId
  ...
  /// Fetch private/locked posts (only for profile owner)
  Future<List<Post>> fetchPrivatePosts(
      {required String type,
      required int? lastItemId}) async {
    // TODO: Backend needs to implement this endpoint
    PostsModel model = await ApiService.instance.call(
        url:
            "${WebService.post.fetchUserPosts}/private", // New endpoint needed
        param: {
          Params.types: type,
          Params.limit: AppRes.paginationLimit,
          Params.lastItemId: lastItemId
  ...
  /// Toggle post privacy (make post private/public)
  Future<StatusModel> togglePostPrivacy(
      {required int postId,
      required bool isPrivate}) async {
    StatusModel model = await ApiService.instance.call(
        url:
            "${WebService.post.fetchUserPosts}/togglePrivacy", // New endpoint needed
        param: {
          Params.postId: postId,
          'isPrivate': isPrivate,
        },
