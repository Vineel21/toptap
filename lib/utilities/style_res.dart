...
class StyleRes {
  static Gradient themeGradient = const LinearGradient(
    colors: [
      ColorRes.likeRed,
      ColorRes.textStoryBgGradient2
    ],
    begin: Alignment.centerLeft,
    end: Alignment.centerRight,
  );

  static Gradient textDarkGreyGradient(
          {double opacity = 1}) =>
      LinearGradient(
        colors: [
  ...
  static Gradient disabledGreyGradient(
          {double opacity = 1}) =>
      LinearGradient(
        colors: [
  ...
  static Gradient textLightGreyGradient(
          {double opacity = 1}) =>
      LinearGradient(
        colors: [
  ...
  static Shader wavesGradient = ui.Gradient.linear(
    ...
    [ColorRes.likeRed, ColorRes.textStoryBgGradient2],
  );
}
