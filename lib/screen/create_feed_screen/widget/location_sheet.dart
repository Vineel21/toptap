...
class LocationSheet extends StatefulWidget {
  ...
  const LocationSheet(
      {super.key, required this.onLocationTap});
          ...
          CustomSearchTextField(
            ...
            onChanged: (value) {
              ...
              DebounceAction.shared.call(() async {
                places.value = [];
                List<Places> _place = await CommonService
                    .instance
                    .searchPlace(title: value);
          ...
          Expanded(
            child: Obx(
              () => ImageTextListTile(
                ...
                noDataWidget: LocationErrorWidget(
...
class LocationErrorWidget extends StatelessWidget {
  ...
  const LocationErrorWidget(
      {super.key, required this.showError});
