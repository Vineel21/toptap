...
class AudioDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(
        AudioDetailsScreenController(music),
        tag: '${music.value?.id}');
    return Scaffold(
      body: Column(
        children: [
          CustomAppBar(
            ...
            rowWidget: Obx(() => InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Image.asset(
                        (controller.music.value?.isSaved ??
                                false)
          ...
          Expanded(
            ...
            onFetchMoreData:
                controller.fetchReelPostsByMusic,
          ))
        ],
      ),
    );
                ...
                children: [
                  ...
                  FullNameWithBlueTick(
                    username: music?.user?.username ??
                        ...
                        '',
                    fontSize: 14,
                    fontColor: textDarkGrey(context),
                    mainAxisAlignment:
