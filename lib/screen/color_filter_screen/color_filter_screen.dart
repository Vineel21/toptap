...
class _ColorFilterScreenState
    extends State<ColorFilterScreen> {
  late final PageController _pageController;
  final RxInt _selectedImageIndex = 0.obs;
  final RxList<ImageWithFilter> _images =
      <ImageWithFilter>[].obs;
  ...
  void _applyFilterToAll() {
    ...
    final selectedFilter =
        _images[_selectedImageIndex.value].colorFilter;
  ...
  void _applyFilterToSelected(
      int index, List<double> filter) {
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Obx(() {
            final isSelected =
                _selectedFilter == filter.colorFilter;
            final thumbnailPath =
