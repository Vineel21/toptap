    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          // Music info section
          Flexible(
            child: _buildMusicInfoSection(
                controller, isReelType, context),
          ),
...
class SelectedMusicView extends StatelessWidget {
  ...
  Widget _buildMusicThumbnailWithDelete(
      BuildContext context) {
    return InkWell(
        ...
        child: Stack(
          ...
          children: [
            CustomImage(
              ...
              radius: 5,
              image: selectedMusic.value?.music?.image
                  ?.addBaseURL(),
              strokeWidth: 2,
              cornerSmoothing: 1,
