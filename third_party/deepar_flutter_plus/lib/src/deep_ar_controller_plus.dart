...
class DeepArControllerPlus {
  ...
  Stream<CameraHealthEvent> get cameraHealthStream =>
      _deepArPlatformHandler.cameraHealthStream;
  ...
  Future<File> takeScreenshot() async {
    ...
    if (filePath == "ENDED_WITH_ERROR") throw ("Screenshot capture failed");
